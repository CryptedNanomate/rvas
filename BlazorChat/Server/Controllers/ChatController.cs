...
//kljucni endpoint, lista poruka izmedju dva korisnika,ovaj endpoint dohvata user id, fetchuje podatke iz baze sa id em od oba korisnika koji se slazu, i vraca poruke.
[HttpGet("{contactId}")]
public async Task<IActionResult> GetConversationAsync(string contactId)
{
    ...
    var messages = await _context.ChatMessages
            ...
            .OrderBy(a => a.CreatedDate) //sloziti poruke po principu prva poslata, FIFO.
 ...
 //dohatamo listu svih korisnika sa ovog endpointa(users)
[HttpGet("users")]
